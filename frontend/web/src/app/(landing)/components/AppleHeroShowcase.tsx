...
import { ArrowUpRight, BookOpen, Code, Terminal } from 'lucide-react';
                    ...
                    <div className="flex items-center justify-between px-3 py-2 border-b border-card-border/40 mb-3 text-xs">
                        ...
                        <div className="flex items-center gap-1.5 font-mono text-[11px]">
                            <button
                                ...
                                className={`px-3 py-1 rounded-full transition-all ${activeScreen === 'portfolio'
                            ...
                            <button
                                ...
                                className={`px-3 py-1 rounded-full transition-all ${activeScreen === 'bible'
                                        ? 'bg-foreground text-background font-semibold shadow-sm'
                                        : 'text-text-subtitle hover:text-foreground hover:bg-inner-card'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-3 py-1 rounded-full transition-all ${activeScreen === 'software'
                                        ? 'bg-foreground text-background font-semibold shadow-sm'
                                        : 'text-text-subtitle hover:text-foreground hover:bg-inner-card'
                                    }`}
                            >
