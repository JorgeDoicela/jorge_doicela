...
function BibleStudyWorkspace({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50/60 dark:bg-black text-foreground flex flex-col selection:bg-primary/10">
      {/* Header Superior Fijo y Persistente (Plano sin botones de toggle fijos) */}
      <BibleHeaderNav />
      ...
      <div className="flex-1 flex flex-row w-full min-h-[calc(100vh-3.5rem)] relative">
        ...
        <main className="flex-1 min-w-0 px-3 sm:px-6 lg:px-8 pt-0 pb-16 space-y-2 overflow-x-hidden print:p-0 print:m-0 print:pb-0">
          {children}
        </main>
