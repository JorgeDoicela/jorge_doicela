  ...
  return (
    ...
    >
      ...
      <div className="pt-4 border-t border-white/5 space-y-3">
        <div className="flex flex-wrap gap-2 text-zinc-400 text-[11px] font-mono">
          ...
          <div className="flex items-center gap-3">
            {project.repoUrl && (
              <span
                ...
                className="text-xs font-semibold text-zinc-400 hover:text-white transition-colors inline-flex items-center gap-1 cursor-pointer"
              >
                <span>GitHub ↗</span>
              </span>
            )}
