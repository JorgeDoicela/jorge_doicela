      ...
      <div className="space-y-3.5">
        ...
        <div>
          <div className="flex items-center justify-between gap-2 mb-1.5">
            ...
            {post.cveId && <span className="text-[11px] font-mono text-rose-400">{post.cveId}</span>}
          </div>

          <h3 className="text-base font-bold text-[var(--header-title)] group-hover:text-rose-300 transition-colors leading-snug line-clamp-2">
            {post.title}
          </h3>
