...
export default function RootLayout({
  ...
  return (
    <html lang="es" className={`${plusJakartaSans.variable} h-full scroll-smooth theme-software`}>
      <body className="font-sans min-h-full theme-software bg-[var(--background)] text-[var(--foreground)] antialiased selection:bg-zinc-300 dark:selection:bg-zinc-800 transition-colors duration-400 tech-grid-bg relative">
