...
server {
    ...
    location /api/chat {
        ...
        # Streaming en tiempo real sin almacenamiento en búfer para IA (Server-Sent Events / Chunks)
        proxy_buffering off;
        proxy_cache off;
        proxy_read_timeout 120s;
    }

    # 2. API REST Backend NestJS (Puerto 3000) - Namespace canónico universal /api/
    location /api/ {
