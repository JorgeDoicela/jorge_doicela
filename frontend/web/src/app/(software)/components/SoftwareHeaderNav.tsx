...
export function SoftwareHeaderNav({
  ...
  return (
    <header className="flex flex-col items-center justify-center pt-2 pb-4 text-center w-full">
      ...
      <Link
        href="/software"
        className="flex items-center justify-center gap-3.5 sm:gap-4.5 select-none hover:opacity-90 transition-opacity"
      >
        <div className={`${compact ? 'h-12 sm:h-16' : 'h-18 sm:h-22 md:h-25 lg:h-28'} w-auto flex items-center justify-center shrink-0`}>
          <Image
        ...
        <div className={`${compact ? 'h-8 sm:h-10' : 'h-11 sm:h-13 md:h-16 lg:h-[72px]'} w-auto flex items-center justify-center`}>
          <Image
      ...
      <div className="flex items-center justify-center gap-2.5 sm:gap-3 mt-1.5 flex-wrap">
        {/* LinkedIn */}
        <a
          ...
          aria-label="LinkedIn"
        >
          <svg className="w-[18px] h-[18px] sm:w-[22px] sm:h-[22px] fill-current" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a
          ...
          aria-label="Email"
        >
          <svg className="w-[18px] h-[18px] sm:w-[22px] sm:h-[22px] fill-none" viewBox="0 0 24 24" stroke="currentColor">
