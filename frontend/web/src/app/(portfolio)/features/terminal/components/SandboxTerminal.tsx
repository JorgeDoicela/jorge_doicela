...
import { SandboxSecurityModal } from './SandboxSecurityModal';
...
export const SandboxTerminal: React.FC<SandboxTerminalProps> = ({
  ...
  return (
    <div className="relative w-full h-full flex-1 min-h-0 rounded-none border-none shadow-none bg-[#080705] overflow-hidden flex flex-col">
      ...
      {/* Modal Dark Luxury overlay para estados de concurrencia y seguridad */}
      {isSecurityState && (
        <div className="absolute inset-0 z-20 w-full h-full p-4 sm:p-8 bg-[#080705] overflow-y-auto flex items-center justify-center animate-fade-in">
          <SandboxSecurityModal
            status={status}
            cooldownSeconds={cooldownSeconds}
            rejectInfo={rejectInfo}
            onTransfer={() => startSession({ forceReplace: true })}
