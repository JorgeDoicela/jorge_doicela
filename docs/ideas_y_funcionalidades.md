...
> Portal de bienvenida. No tiene backend ni base de datos. Toda la lógica es del lado del cliente.

### Diseño Visual y Experiencia de Usuario (UX/UI)
- [ ] **Cursor personalizado**: Reemplazar el cursor del sistema operativo por uno personalizado animado que reacciona al pasar sobre elementos interactivos (ej. un punto con halo o una cruz con brillo).
- [ ] **Efecto Parallax en el fondo**: Las elipses degradadas del fondo se mueven a distinta velocidad que el contenido al hacer scroll, generando profundidad tridimensional.
- [ ] **Partículas interactivas de fondo**: Pequeñas partículas flotantes (tipo Three.js o Tsparticles) que reaccionan al movimiento del ratón acercándose o alejándose del cursor.
...
- [ ] **Tilt 3D en tarjetas al hover**: Las tarjetas de redirección (Portafolio, Biblia, Software) rotan suavemente en el eje X e Y según la posición del cursor sobre ellas, simulando un efecto de inclinación tridimensional.
...
- [ ] **Gradiente de fondo reactivo al cursor**: El gradiente del fondo de la página se desplaza sutilmente siguiendo la posición del ratón en tiempo real.
- [ ] **Paleta de temas adicionales**: Más allá de claro/oscuro, ofrecer temas de color alternos (ej. tema índigo, tema sepia, tema salmón).
- [ ] **Animación de scroll suave y progress bar**: Barra de progreso de lectura que indica cuánto ha scrolleado el visitante.
- [ ] **Easter egg interactivo**: Un comando o combinación de teclas secreto que dispara una animación o mensaje especial (ej. el Konami Code que ejecuta neofetch en pantalla).
...
- [ ] **PWA (Progressive Web App)**: Configurar manifest.json y un service worker básico para que la landing se pueda instalar como app en el móvil del visitante.
...
> Portafolio de alto impacto visual con terminal SSH interactiva en tiempo real.
...
- [ ] **Tarjetas 3D del stack tecnológico**: Las tarjetas rotan y muestran más información al hacer hover, con efecto de profundidad.
...
## Biblia Modular (`bible.jorgedoicela.com`) — Frontend + Backend

> Lector digital minimalista de las Sagradas Escrituras.
...
- [ ] **Bookmarks / Marcadores**: El usuario puede marcar versículos favoritos almacenados en localStorage o en el backend.
- [ ] **Historial de lectura**: Registro del último versículo/capítulo visitado para retomar donde se dejó.
...
- [ ] **Lector de audio (Text-to-Speech)**: Botón para escuchar el capítulo leído en voz alta mediante Web Speech API o un servicio TTS externo.
...
- [ ] **Compartir versículo**: Botón en cada versículo para copiar la referencia y el texto al portapapeles o compartir en redes sociales.
- [ ] **Notificación de versículo del día (push web)**: El usuario puede suscribirse a notificaciones push para recibir el versículo del día cada mañana.

### Funcionalidades de Estudio Bíblico
- [ ] **Sistema de Notas por Versículo**: Cada versículo puede tener una nota privada del usuario almacenada en localStorage o en el backend.
...
- [ ] **Generador de imágenes de versículo**: Seleccionar un versículo y generar automáticamente una imagen lista para compartir en Instagram o WhatsApp.
...
- [ ] **Diccionario bíblico integrado**: Al hacer doble clic sobre una palabra, mostrar su definición y apariciones en la Biblia.
...
> Catálogo visual y técnico de proyectos y herramientas desarrolladas por Jorge.
...
- [ ] **Enlace a demo en vivo con iframe preview**: Al pasar el cursor sobre una tarjeta, mostrar una miniatura de la vista previa de la URL en producción.
- [ ] **Carousel de imágenes por proyecto**: Galería deslizante de capturas de pantalla dentro de la página de detalle.
