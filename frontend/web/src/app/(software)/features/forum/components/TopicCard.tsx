  ...
  return (
    ...
    >
      <div className="flex-1">
        ...
        <h3 className="text-base font-bold text-[var(--foreground)] group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors leading-snug">
          {topic.title}
        </h3>
        <p className="text-xs text-slate-600 dark:text-zinc-400 line-clamp-2 mt-1 font-normal dark:font-light">
          {topic.content}
        </p>
      </div>

      <div className="flex items-center gap-4 self-end md:self-center border-t md:border-t-0 pt-3 md:pt-0 border-slate-200/70 dark:border-white/5">
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl glass-concave-panel text-xs text-blue-600 dark:text-blue-400 font-semibold font-mono">
        ...
        <span className="px-3 py-1.5 rounded-xl glass-btn-neumorphic text-xs font-semibold text-slate-600 dark:text-zinc-400 group-hover:text-slate-900 dark:group-hover:text-white group-hover:translate-x-0.5 transition-all">
          {tCard('viewTopic')}
        </span>
      </div>
    </Link>
